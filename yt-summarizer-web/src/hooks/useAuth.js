...
function AuthProvider(_a) {
    ...
    var auth = (0, auth_1.getAuth)(firebase_1.firebaseApp);
    (0, react_1.useEffect)(function () {
        var unsubscribe = (0, auth_1.onAuthStateChanged)(auth, function (firebaseUser) {
    ...
    var login = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    react_hot_toast_1.default.success("Logged in successfully");
                    return [3 /*break*/, 4];
                case 2:
                    err_1 = _a.sent();
                    react_hot_toast_1.default.error(err_1.message || "Failed to login");
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    var signup = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    react_hot_toast_1.default.error(err_2.message || "Failed to sign up");
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    var logout = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_3 = _a.sent();
                    react_hot_toast_1.default.error("Failed to logout");
                    return [3 /*break*/, 3];
